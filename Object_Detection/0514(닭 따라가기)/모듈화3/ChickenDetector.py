...
class ChickenDetector:
    """YOLO 모델을 사용하여 닭을 감지하고 추적하는 클래스 (ID 관리 기능 특화)"""
    ...
    def __init__(self, model_path):
        ...
        try:
            ...
            self.enabled = True
            self.tracking_enabled = True  # 객체 추적 항상 활성화
            ...
            self.use_consistent_ids = True # 일관된 ID 사용 항상 활성화
            
            # 객체 추적 설정
            self.distance_threshold = 25  # 같은 객체로 판단할 최대 거리
            self.time_threshold = 1.5     # 같은 객체로 판단할 최대 시간 차이 (초)
